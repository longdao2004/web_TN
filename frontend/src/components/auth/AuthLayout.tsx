...
export const AuthLayout = ({ children, type = 'login', variant = 'split' }: AuthLayoutProps) => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50">
      ...
      <main className="flex-1 w-full py-10 lg:py-14 px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
        <div className={`mx-auto w-full ${isCentered ? 'max-w-lg' : 'max-w-6xl'}`}>
