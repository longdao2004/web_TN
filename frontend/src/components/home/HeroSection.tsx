        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-start space-y-6 z-10">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              Nông sản{" "}
              <span className="text-[var(--color-primary)]">Tươi Sạch</span>{" "}
              <br className="hidden sm:block" />
              An Toàn Cho Sức Khỏe
            </h1>

            <p className="max-w-lg text-lg text-gray-600">
              Kết nối trực tiếp người nông dân với người tiêu dùng. Cung cấp các
              loại rau củ quả, thịt cá tươi sống chuẩn VietGAP mỗi ngày.
            </p>
