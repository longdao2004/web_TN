      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">
          ...
          <span className="text-emerald-400">
            Kết nối nông sản sạch đến mọi gia đình
          </span>
        </h1>
        <p className="mx-auto max-w-2xl text-lg sm:text-xl text-emerald-100 mb-10 leading-relaxed">
          Nền tảng thương mại điện tử giúp kết nối nông dân, cửa hàng nông sản
          và người tiêu dùng trên toàn quốc. Đảm bảo chất lượng, minh bạch và an
          toàn.
        </p>
        <Link href="/san-pham">
          <Button
            size="lg"
            className="bg-emerald-500 hover:bg-emerald-400 text-white border-none shadow-lg shadow-emerald-500/30 text-lg px-8 h-14 font-semibold group rounded-full"
          >
            Khám phá sản phẩm
